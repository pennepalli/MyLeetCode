...
x="-".join(c for c in words)
print (x)
print ("Reverse:", x[::-1])
print ("Argv[1:] ", words[1:])
print ("Argv[2:] ", words[2:])
...
#  my_list[:5] # Extracts elements from the beginning of the list up to index 5 (exclusive). (Omitting start defaults to 0). Result: [0, 1, 2, 3, 4]
...
#  my_list[::-1] # Reverses the entire list. Result: [9, 8, 7, 6, 5, 4, 3, 2, 1, 0]
